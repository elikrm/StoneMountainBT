...
//Open, manage and close the data Stream from the Stone Mountain BT device
public class ConnectedThread extends Thread {
    ...
    public void run() {
        ...
        int numberOfReadings = 0; //to control the number of readings from the Stone Mountain

        // Keep listening to the InputStream until an exception occurs.
        //We just want to get 1 readings from the StoneMountain
